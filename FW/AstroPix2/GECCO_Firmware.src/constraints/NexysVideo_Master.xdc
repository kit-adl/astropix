...
set_property -dict { PACKAGE_PIN B18   IOSTANDARD LVCMOS25 } [get_ports { config_rb }]; #IO_L11N_T1_SRCC_16 Sch=fmc_la17_cc_n
set_property -dict { PACKAGE_PIN B17   IOSTANDARD LVCMOS25 } [get_ports { config_sout }]; #IO_L11P_T1_SRCC_16 Sch=fmc_la17_cc_p
...
set_property -dict { PACKAGE_PIN C17   IOSTANDARD LVCMOS25 } [get_ports { hold }]; #IO_L12N_T1_MRCC_16 Sch=fmc_la18_cc_n
set_property -dict { PACKAGE_PIN D17   IOSTANDARD LVCMOS25 } [get_ports { res_n }]; #IO_L12P_T1_MRCC_16 Sch=fmc_la18_cc_p
set_property -dict { PACKAGE_PIN F20   IOSTANDARD LVCMOS25 } [get_ports { interrupt }]; #fmc_la_n[20] }]; #IO_L18N_T2_16 Sch=fmc_la_n[20]

#Clocks
set_property -dict { PACKAGE_PIN F19   IOSTANDARD LVCMOS25 } [get_ports { timestamp_clk }]; #IO_L18P_T2_16 Sch=fmc_la_p[20]

set_property -dict { PACKAGE_PIN D21   IOSTANDARD LVDS_25 } [get_ports { sample_clk_n }]; #IO_L23N_T3_16 Sch=fmc_la_n[22]
set_property -dict { PACKAGE_PIN E21   IOSTANDARD LVDS_25 } [get_ports { sample_clk_p }]; #IO_L23P_T3_16 Sch=fmc_la_p[22]

set_property -dict { PACKAGE_PIN B16   IOSTANDARD LVDS_25 } [get_ports { sample_clk_se_n }]; #IO_L7N_T1_16 Sch=fmc_la_n[24]
set_property -dict { PACKAGE_PIN B15   IOSTANDARD LVDS_25 } [get_ports { sample_clk_se_p }]; #IO_L7P_T1_16 Sch=fmc_la_p[24]

#SPI left
set_property -dict { PACKAGE_PIN A21   IOSTANDARD LVCMOS25 } [get_ports { spi_left_clk}]; #cdo_n }]; #IO_L21N_T3_DQS_16 Sch=fmc_la_n[23]
set_property -dict { PACKAGE_PIN B21   IOSTANDARD LVCMOS25 } [get_ports { spi_left_csn}]; #cdo_p }]; #IO_L21P_T3_DQS_16 Sch=fmc_la_p[23]
set_property -dict { PACKAGE_PIN D19   IOSTANDARD LVCMOS25 } [get_ports { spi_left_miso0 }]; #fmc_la_n[21] }]; #IO_L14N_T2_SRCC_16 Sch=fmc_la_n[21]
set_property -dict { PACKAGE_PIN E19   IOSTANDARD LVCMOS25 } [get_ports { spi_left_miso1 }]; #IO_L14P_T2_SRCC_16 Sch=fmc_la_p[21]
set_property -dict { PACKAGE_PIN A18   IOSTANDARD LVCMOS25 } [get_ports { spi_left_mosi }]; #IO_L17P_T2_16 Sch=fmc_la_p[19]

#SPI right
set_property -dict { PACKAGE_PIN L14   IOSTANDARD LVCMOS25 } [get_ports { spi_right_mosi }]; #IO_L22P_T3_A17_15 Sch=fmc_la_p[11]
set_property -dict { PACKAGE_PIN J17   IOSTANDARD LVCMOS25 } [get_ports { spi_right_csn }]; #{ fmc_la_n[13] }]; #IO_L21N_T3_DQS_A18_15 Sch=fmc_la_n[13]
set_property -dict { PACKAGE_PIN K17   IOSTANDARD LVCMOS25 } [get_ports { spi_right_miso0 }]; #IO_L21P_T3_DQS_15 Sch=fmc_la_p[13]
set_property -dict { PACKAGE_PIN K16   IOSTANDARD LVCMOS25 } [get_ports { spi_right_miso1 }]; #IO_L23N_T3_FWE_B_15 Sch=fmc_la_n[15]
set_property -dict { PACKAGE_PIN L16   IOSTANDARD LVCMOS25 } [get_ports { spi_right_clk }]; #IO_L23P_T3_FOE_B_15 Sch=fmc_la_p[15]
...
set_property -dict { PACKAGE_PIN A15   IOSTANDARD LVDS_25 } [get_ports { config_ld_p }]; #IO_L9P_T1_DQS_16 Sch=fmc_la_p[32]
#IN2
set_property -dict { PACKAGE_PIN F14   IOSTANDARD LVDS_25 } [get_ports { config_ck2_n }]; #IO_L1N_T0_16 Sch=fmc_la_n[33]
set_property -dict { PACKAGE_PIN F13   IOSTANDARD LVDS_25 } [get_ports { config_ck2_p }]; #IO_L1P_T0_16 Sch=fmc_la_p[33]
#IN3
...
set_property -dict { PACKAGE_PIN E13   IOSTANDARD LVDS_25 } [get_ports { config_ck1_p }]; #IO_L4P_T0_16 Sch=fmc_la_p[31]

#If config_singleended
#IN1
#set_property -dict { PACKAGE_PIN A16   IOSTANDARD LVCMOS25 } [get_ports { config_ld_n }]; #IO_L9N_T1_DQS_16 Sch=fmc_la_n[32]
#set_property -dict { PACKAGE_PIN A15   IOSTANDARD LVCMOS25 } [get_ports { config_ld_p }]; #IO_L9P_T1_DQS_16 Sch=fmc_la_p[32]
#IN2
#set_property -dict { PACKAGE_PIN F14   IOSTANDARD LVCMOS25 } [get_ports { config_ck2_n }]; #IO_L1N_T0_16 Sch=fmc_la_n[33]
#set_property -dict { PACKAGE_PIN F13   IOSTANDARD LVCMOS25 } [get_ports { config_ck2_p }]; #IO_L1P_T0_16 Sch=fmc_la_p[33]
#IN3
#set_property -dict { PACKAGE_PIN A14   IOSTANDARD LVCMOS25 } [get_ports { config_sin_n }]; #IO_L10N_T1_16 Sch=fmc_la_n[30]
#set_property -dict { PACKAGE_PIN A13   IOSTANDARD LVCMOS25 } [get_ports { config_sin_p }]; #IO_L10P_T1_16 Sch=fmc_la_p[30]
#IN4
#set_property -dict { PACKAGE_PIN E14   IOSTANDARD LVCMOS25 } [get_ports { config_ck1_n }]; #IO_L4N_T0_16 Sch=fmc_la_n[31]
