...
For now only configuration for analog outputs is available, readout counters using SPI is not available yet. 


This project is best build using QT Creator under windows, Linux support requires a bit more support for thhe FTDI driver.

## Building under windows


- Install QT and QT Creator from QT official website using the community download packages
- Install QT 5 with Mingw 64bit runtime 
- Open the Project in QT Creqtor, it should build right and run out of the box 
