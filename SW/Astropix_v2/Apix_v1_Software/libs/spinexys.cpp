...
bool SPINexys::WriteNoCheck(NexysIO *nexys, int setting)
{
    ...
    uint64_t setting2 = uint64_t(setting);
    std::cout << "Writenocheck setting: " << setting << "\n";
    config.push_back(static_cast<byte>(setting2 >> 56));
    config.push_back(static_cast<byte>(setting2 >> 48));
    config.push_back(static_cast<byte>(setting2 >> 40));
    config.push_back(static_cast<byte>(setting2 >> 32));
    config.push_back(static_cast<byte>(setting2 >> 24));
    config.push_back(static_cast<byte>(setting2 >> 16));
    config.push_back(static_cast<byte>(setting2 >>  8));
    config.push_back(static_cast<byte>(setting2      ));
